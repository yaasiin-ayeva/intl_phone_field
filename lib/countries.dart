...
const List<Country> countries = [
  ...
  Country(
    ...
    nameTranslations: {
      ...
      "si": "බ්‍රිතාන්‍ය ඉන්දියන් සාගර බලප්‍රදේශය",
    },
    flag: "🇮🇴",
    code: "IO",
    dialCode: "246",
  ...
  Country(
    ...
    nameTranslations: {
      ...
      "yue": "赫德岛同麦克唐纳群岛",
      "hi": "हर्ड द्वीप और मैकडोनाल्ड द्वीप समूह",
      "pt": "Ilhas Heard e McDonald",
      "ru": "Остров Херд и острова Макдональд",
      "si": "හර්ඩ් දිවයින සහ මැක්ඩොනල්ඩ් දූපත්",
    },
    flag: "🇭🇲",
    code: "HM",
    dialCode: "672",
  ...
  Country(
    ...
    nameTranslations: {
      ...
      "fa": "سن-پیر و میکلون",
      "yue": "聖皮埃尔同米克隆",
      "hi": "सेंट पियरे और मिकेलान",
      "pt": "São Pedro e Miquelon",
      "ru": "Сен-Пьер и Микелон",
      "si": "ශාන්ත පියරේ සහ මික්වලන්",
    },
    flag: "🇵🇲",
    code: "PM",
    dialCode: "508",
  ...
  Country(
    ...
    nameTranslations: {
      ...
      "si": "ශාන්ත වින්සන්ට් සහ ග්‍රෙනඩයින්ස්",
    },
    flag: "🇻🇨",
    code: "VC",
    dialCode: "1784",
